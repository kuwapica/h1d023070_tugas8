...
class _ProdukFormState extends State<ProdukForm> {
  ...
  String judul = "TAMBAH PRODUK NIDA";
  ...
  isUpdate() {
    if (widget.produk != null) {
      setState(() {
        judul = "UBAH PRODUK NIDA";
        tombolSubmit = "UBAH PRODUK NIDA";
      ...
      judul = "TAMBAH PRODUK NIDA";
      tombolSubmit = "SIMPAN PRODUK NIDA";
    }
  }
    ...
    return OutlinedButton(
      ...
      onPressed: () {
        ...
        if (validate) {
          ...
          Produk data = Produk(
            id: widget.produk?.id, // kalau edit, id tetap
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => ProdukDetail(produk: data)),
          );
        }
      },
    );
